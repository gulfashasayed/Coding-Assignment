...
FileInputStream fis=new FileInputStream("sample_input.txt"); // read input from file      
Scanner sc=new Scanner(fis);

int number_of_employees = Integer.parseInt(sc.nextLine().split(": ")[1]);
sc.nextLine(); sc.nextLine(); sc.nextLine();

ArrayList<Item> goodies_items = new ArrayList<Item>();//creating arraylist 
...
Collections.sort(goodies_items, new Comparator<Item>(){//sorting of items
...
FileWriter fw = new FileWriter("sample_output.txt");//writing to output file
